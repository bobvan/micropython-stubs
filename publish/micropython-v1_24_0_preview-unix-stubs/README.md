...
Included stubs:
* Merged stubs from `stubs/micropython-v1_24_0_preview-unix-GENERIC-merged`
* Frozen stubs from `stubs/micropython-v1_24_0_preview-frozen/unix/GENERIC`
...
Core | micropython | unix | - | v1.24.0-preview 
