...
Included stubs:
* Merged stubs from `stubs/micropython-v1_24_0_preview-webassembly-GENERIC-merged`
* Frozen stubs from `stubs/micropython-v1_24_0_preview-frozen/webassembly/GENERIC`
* Core stubs from `stubs/micropython-core`


origin | Family | Port | Board | Version
-------|--------|------|-------|--------
Documentation | micropython | - | - | v1.24.0-preview 
Core | micropython | webassembly | - | v1.24.0-preview 
