...
MicroPython module: https://docs.micropython.org/en/v1.25.0-preview/library/rp2.html
...
class PIOASMEmit:
    ...
    def __init__(
        self,
        *,
        out_init: Incomplete | None = None,
        set_init: Incomplete | None = None,
        sideset_init: Incomplete | None = None,
        in_shiftdir: int = 0,
        out_shiftdir: int = 0,
        autopush: bool = False,
        autopull: bool = False,
    ...
    def word(self, instr, label: Incomplete | None = None): ...
    def nop(self): ...
    def jmp(self, cond, label: Incomplete | None = None): ...
    def wait(self, polarity, src, index): ...
    def in_(self, src, data): ...
    def out(self, dest, data): ...
    def push(self, value: int = 0, value2: int = 0): ...
    def pull(self, value: int = 0, value2: int = 0): ...
    def mov(self, dest, src): ...
    def irq(self, mod, index: Incomplete | None = None): ...
...
def asm_pio_encode(instr, sideset_count, sideset_opt: bool = False) -> Incomplete:
    """
