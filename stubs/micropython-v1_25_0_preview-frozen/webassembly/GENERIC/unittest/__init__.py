...
def _handle_test_exception(current_test: tuple, test_result: TestResult, exc_info: tuple, verbose=True):
    exc = exc_info[1]
...
def _run_suite(c, test_result: TestResult, suite_name=""):
    ...
    def run_one(test_function):
        ...
        try:
            ...
            _handle_test_exception(current_test=(name, c), test_result=test_result, exc_info=(type(ex), ex, None))
