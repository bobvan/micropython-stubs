...
class BaseModem:
    ...
    def start_recv(self, timeout_ms=None, continuous: bool = False, rx_length: int = 255) -> None: ...
...
class RxPacket(bytearray):
    ...
    def __init__(self, payload, ticks_ms=None, snr=None, rssi=None, valid_crc: bool = True) -> None: ...
