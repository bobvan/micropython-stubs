...
class Lora:
    ...
    def __init__(self, uart=None, rst_pin=None, boot_pin=None, band=..., poll_ms: int = 300000, debug: bool = False) -> None: ...
    ...
    def receive(self, delimiter=None, max_bytes=None, timeout: int = 1000): ...
    def available(self): ...
    def join_OTAA(self, appEui, appKey, devEui=None, timeout: int = 60000): ...
    def join_ABP(self, nwkId, devAddr, nwkSKey, appSKey, timeout: int = 60000): ...
    def handle_error(self, command, data) -> None: ...
    def send_command(self, cmd, *args, delimiter: str = "\r", data=None, timeout: int = 1000, raise_error: bool = True): ...
