...
MicroPython module: https://docs.micropython.org/en/preview.0/library/ssl.html
...
"""Supported values for the *protocol* parameter."""
PROTOCOL_DTLS_CLIENT (when DTLS support is enabled): Incomplete
"""Supported values for the *protocol* parameter."""
PROTOCOL_DTLS_SERVER (when DTLS support is enabled): Incomplete
"""Supported values for the *protocol* parameter."""
...
class SSLContext():
    ...
    def wrap_socket(self, sock, *, server_side=False, do_handshake_on_connect=True, server_hostname=None) -> Incomplete:
        ...
        """
        ...
def wrap_socket(sock, server_side=False, key=None, cert=None, cert_reqs=None, cadata=None, server_hostname=None, do_handshake=True) -> SSLSocket:
    """
