...
MicroPython module: https://docs.micropython.org/en/v1.24.0-preview/library/random.html
...
---
Module: 'urandom' on micropython-v1.21.0-unix-linux_[GCC_9.4.0]_version
"""
