...
MicroPython module: https://docs.micropython.org/en/v1.25.0-preview/library/uctypes.html
...
---
Module: 'uctypes' on micropython-v1.21.0-unix-linux_[GCC_9.4.0]_version
"""
...
LONG = 939524096  # type: int
UINT = 536870912  # type: int
ULONG = 805306368  # type: int
