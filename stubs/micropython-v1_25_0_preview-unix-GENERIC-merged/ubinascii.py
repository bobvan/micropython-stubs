...
MicroPython module: https://docs.micropython.org/en/v1.25.0-preview/library/binascii.html
...
---
Module: 'ubinascii' on micropython-v1.21.0-unix-linux_[GCC_9.4.0]_version
"""
