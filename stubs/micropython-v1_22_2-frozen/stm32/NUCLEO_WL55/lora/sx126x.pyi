...
class _SX126x(BaseModem):
    ...
    def start_recv(self, timeout_ms: Incomplete | None = None, continuous: bool = False, rx_length: int = 255): ...
    ...
    def _cmd(self, fmt, *write_args, n_read: int = 0, write_buf: Incomplete | None = None, read_buf: Incomplete | None = None): ...
...
class _SX1262(_SX126x):
    def __init__(
        ...
        cs,
        busy,
        dio1: Incomplete | None = None,
        dio2_rf_sw: bool = True,
        dio3_tcxo_millivolts: Incomplete | None = None,
        dio3_tcxo_start_time_us: int = 1000,
        reset: Incomplete | None = None,
        lora_cfg: Incomplete | None = None,
        ant_sw: Incomplete | None = None,
    ) -> None: ...
    def _tx_hp(self): ...
